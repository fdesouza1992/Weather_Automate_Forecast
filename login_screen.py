...
class LoginScreen:
    ...
    def _setup_login_form(self):
        ...
        forgot_password.bind(
            "<Button-1>", 
            lambda e: self._handle_password_reset())
    ...
    def _setup_register_form(self):
        ...
        self.reg_confirm.bind(
            '<Return>', 
            lambda e: self._handle_register())
